...
class HorarioService implements HorarioServiceInterface{
    ...
    public function getAvailableIntervals($date, $doctorId){
        ...
        $morningIntervalos = $this->getIntervalos($horario->morning_start, $horario->morning_end, $doctorId,$date);
        $afternoonIntervalos = $this->getIntervalos($horario->afternoon_start, $horario->afternoon_end,$doctorId,$date);
