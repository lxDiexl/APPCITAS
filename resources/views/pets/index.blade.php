            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-5 my-auto text-end">
                            <a href="{{ url('/pets/create') }}" class="btn btn-sm btn-success">Nueva Mascota</a>
                        </div>
                    </div>
               ...
               <form id="searchForm" action="{{ url('/pets') }}" method="GET" style="margin-left: 30px;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            ...
                                            <form action="{{url('/pets/'.$pet->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <a href="{{url('/pets/'.$pet->id.'/edit')}}" class="btn btn-sm btn-danger">Editar</a>
