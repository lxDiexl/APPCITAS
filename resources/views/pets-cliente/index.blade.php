    ...
    <div class="row mb-4">
        <div class="col-lg-12 col-md-6 mb-md-0 mb-4">
            <div class="card">
                <div class="card-header pb-0">
                    <div class="row">
                        <div class="col-lg-6 col-7">
                            <h2 style="letter-spacing: 3px;">MASCOTAS</h2>
                        ...
                        <div class="col-lg-6 col-5 my-auto text-end">
                            <a href="{{ url('/pets-cliente/create') }}" class="btn btn-sm btn-success">Nueva Mascota</a>
                        </div>
                    </div>
               ...
               <form id="searchForm" action="{{ url('/pets-cliente') }}" method="GET" style="margin-left: 30px;">
                            ...
                            <tbody>
                                @foreach ($pets as $pet)
                                    <tr>
                                        ...
                                        <td scope="row" class="text-center">
                                            {{ User::find($pet->id_user)->name }}
                                        </td>
                                        <td class="align-middle text-center text-sm">

                                            <form action="{{url('/pets-cliente/'.$pet->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <a href="{{url('/pets-cliente/'.$pet->id.'/edit')}}"
