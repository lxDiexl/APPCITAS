            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-5 my-auto text-end">
                            <a href="{{ url('/adoption') }}" class="btn btn-sm btn-info"><i class="fas fa-arrow-alt-circle-left"
                ...
                <div class="card-body">
                    ...
                    @if ($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form action="{{ url('/adoption/' . $pet->id) }}" method="POST" class="form"
                        ...
                        {{-- <div class="form-group">
                            ...
                            line-height: 1.5;
                            transition: border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out;"
                                type="text" name="imagen" class="form-control"
                                value="{{ old('imagen', $pet->imagen) }}">
                        </div> --}}
