...
<head>
  ...
  height: 100%;
        ...
        #acercade {
            height: 1020px;
            background: url(https://images5.alphacoders.com/364/364184.jpg) no-repeat center;
            background-size: cover
        }
        #servicios {
            height: 1020px;
...
<body class="">
                    ...
                    <div class="container-fluid ps-2 pe-0">
                      ...
                      <div class="collapse navbar-collapse" id="navigation">
                        ...
                        @if (Route::has('login'))
                            ...
                            @auth
                                <a href="{{ url('/home') }}" class="btn btn-sm mb-0 me-1 bg-gradient-dark" style="background: #3D413E;">Home</a>
                            @else
    ...
    <header id="content-header">
        ...
        <p id="lorem" style="font-size:20px; color:black">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            ...
            Incidunt ad vitae iste distinctio natus a culpa excepturi
            cum, nostrum, libero error animi sit quod sequi eveniet tempore?
                ...
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-6">
                            ...
                            Únete para conocer más de nosotros</p>
                                <form action="#">
                                    <div class="form-row">
